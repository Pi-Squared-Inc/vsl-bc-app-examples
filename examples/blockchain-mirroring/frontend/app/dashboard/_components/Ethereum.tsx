...
import EthereumMirroringTable from "@/app/_components/EthereumMirroringTable";
...
export default function Ethereum() {
  ...
  const fetchValidationRecords = useCallback(
    async (page: number, loadingType: "initial" | "refresh" | "page" = "initial") => {
      ...
      try {
        const response = await axios.get(`${process.env.NEXT_PUBLIC_API_URL}/block_mirroring_records?page=${page}`);
