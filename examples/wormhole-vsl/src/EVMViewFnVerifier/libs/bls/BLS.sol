...
library BLS {
    ...
    {
        require(pubkeys.length > 0, "BLS: number of public key is zero");
        uint256 inputSize = (pubkeys.length + 1) * 6;
        ...
        uint256 perPairCost = 34000;
        uint256 baseCost = 45000;
        uint256 precompileGasCost = (pubkeys.length + 1) * perPairCost + baseCost;
